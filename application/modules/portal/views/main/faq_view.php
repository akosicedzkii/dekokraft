...
<div class="box">
    ...
    <!-- /.box-header -->
<div class="box-body">
    <form class="form-horizontal" id="FAQForm" data-toggle="validator">
        <div class="box-body">
            <div class="form-group">

                <div class="col-md-12">
                <textarea id="inputText" class="form-control" style="height:500px;"><?php echo $dynamic_settings->faqs;?></textarea>
    ...
    var main = function(){
        ...
        $("#FAQForm").submit(function(e){
          ...
          var btn =  $("#saveSettings");
            ...
            var dynamic_faqs  = editor.getData();
            formData.append("faqs" , dynamic_faqs);
            $('#uploadBoxMain').html('<div class="progress"><div class="progress-bar progress-bar-aqua" id = "progressBarMain" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 0%"><span class="sr-only">20% Complete</span></div></div>');
                $.ajax({
                    ...
                    contentType: false,
                    cache: false,
                    url: "<?php echo base_url()."portal/faq/update_settings";?>" ,
                    xhr: function(){
                        //upload Progress
