        ...
        <div class="row">
            ...
            <select id="invoice_type" style="width:200px;" class="form-control pull-left">
                   <option value="proforma">Proforma Invoice</option>
                    ...
                    <option value="sample">PQ Proforma Invoice</option>
                </select>
            </div>
            <!-- /.col -->
        </div>
                ...
                console.log(prod_var_id)
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            //$('#product'+  $("#line_number").val()).append(new Option(data["description"] +" - " +data["color"],data["product_id"],  true, true)).trigger('change');
                        },
