...
class Job_orders extends CI_Controller
{
    ...
    public function get_job_orders_list()
    {
        ...
        foreach ($rResult->result_array() as $aRow) {
            ...
            $btns .= '
            <a href="'.base_url("portal/main/job_orders/print?job_id=".$aRow['id']).'" target=_blank class="glyphicon glyphicon-print text-orange" data-toggle="tooltip" title="Print Job Order"></a>
            <a href="'.base_url("portal/main/job_orders/prints?job_id=".$aRow['id']).'" target=_blank class="glyphicon glyphicon-print text-yellow" data-toggle="tooltip" title="Print Job Order List and Sub BQ"></a>
