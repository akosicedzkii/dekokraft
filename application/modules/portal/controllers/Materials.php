...
class Materials extends CI_Controller {
    ...
    public function get_materials_list()
    {
        ...
        $this->dt_model->select_columns = array("t1.id","t1.material_name","t1.unit","t1.cost","t1.jp","IF(t1.status=1,'Active','Inactive') as status","t1.date_created","t2.username as created_by","t1.date_modified","t3.username as modified_by");  
        $this->dt_model->where  = array("t1.id","t1.material_name","t1.unit","t1.cost","t1.jp","t1.status","t1.date_created","t2.username","t1.date_modified","t3.username");  
        $select_columns = array("id","material_name","unit","cost","jp","status","date_created","created_by","date_modified","modified_by");  
