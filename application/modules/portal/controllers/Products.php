...
class Products extends CI_Controller {
    ...
    public function get_products_list()
    {
        ...
        $this->dt_model->select_columns = array("t1.id","t1.class","t1.code","t1.description","t1.inner_carton","t1.master_carton","t1.minimum_of_quantity","t1.lowest_cost","t1.best_price","t1.fob","t1.status","(SELECT SUM(count) from product_variants WHERE product_id=t1.id  where t1.status=1) as quantity");  
