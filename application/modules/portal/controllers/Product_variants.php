...
class Product_variants extends CI_Controller {
    ...
    public function get_product_variants_list()
    {
        ...
        $select_columns = array("id","cover_image","class","code","xxx","location","color","proto","molds","stock","fob","status");  
        if($this->session->userdata("USERTYPE") ==1)
        {
            $select_columns = array("id","cover_image","class","code","xxx","location","color","proto","molds","stock","fob","status","date_created","created_by","date_modified","modified_by");
        }  
